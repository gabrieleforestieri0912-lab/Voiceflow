    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="mx-auto max-w-2xl p-6">
        ...
        <section className="space-y-5 rounded-2xl border border-zinc-800 bg-zinc-900/40 p-5">
          ...
          <div className="rounded-xl bg-amber-950/30 p-3 text-xs leading-5 text-amber-200/90">
            <strong>Checkpoint 2 — verifica hotkey:</strong> tieni premuto Ctrl+Spazio e parla — l&apos;overlay deve apparire. Rilascia per
            trascrivere. Se l&apos;hook globale è bloccato da antivirus/EDR, vedrai un avviso in console e la dettatura non partirà; usa il
            toggle Pausa/Riprendi dal tray.
          </div>
        </section>
